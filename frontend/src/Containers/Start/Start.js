        ...
        <Row>
          <Col>
            <Jumbotron className={classes.Jumbo}>
              ...
              <p>
                Cieszymy się, że jesteś z nami <strong>{this.state.user.first_name}</strong>. Szlifuj swój angielski wraz z
                aplikacją Wordsmaster! Sprawdź listę poniżej i poznaj niektóre z możliwości
                aplikacji.
              </p>
              <div>
              ...
              <p>
                Kliknij w przycisk poniżej, stwórz własną listę słówek i rozpocznij naukę :)
              </p>
              <p>
