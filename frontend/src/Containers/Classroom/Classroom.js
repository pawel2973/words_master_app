  ...
  render() {
    ...
    return (
      <Wrapper>
        ...
        <h1>
          <i className="fas fa-chalkboard-teacher" /> Classroom
        </h1>

        <Breadcrumb>
          <BreadcrumbItem active>Classroom</BreadcrumbItem>
        </Breadcrumb>

        <Wrapper>
          <Form>
            <h5>Create new classroom</h5>
            <Form.Group controlId="Classroom.Title">
              <Form.Row>
                <Col xl={10} lg={9} md={9} sm={8} xs={8}>
                  <Form.Control
                    ...
                    onChange={event =>
                      this.setState({ wordlist_name: event.target.value })
                    }
                  />
                </Col>
