    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('user', 'użytkownik'), ('teacher', 'nauczyciel')], default='user', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classtest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.ClassTest')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('userwordlist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.UserWordList')),
            ],
        ),
        migrations.CreateModel(
            name='UserTestAnswer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polish', models.CharField(max_length=255)),
                ('english', models.CharField(max_length=255)),
                ('classwordlist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.ClassWordList')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Teacher')),
            ],
        ),
        migrations.AddField(
